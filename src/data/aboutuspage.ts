export interface aboutUsSpec{
    title:string;
    paragraphs:string[]
}
export const AboutUsData:aboutUsSpec = {
    title:'About Us',
    paragraphs:[
