        ...
        list:[
            {
                ...
                paragraphs:[
`The <a href="https://www.isid.ac.in/~cecfee/">Centre for research on the Economics\
...
`,
`The applicant must have a PhD in Economics with a credible research agenda in the field of labor economics,\
...
`,
`Come, join us for cutting edge research on India’s labor markets!`,
`If interested, email CV and JMP to cecfee[at]isid.ac.in. \
Applications will be accepted until the position is filled or cancelled. The position is subject to availability of funds.\
`,
`Over the years, the Economics and Planning Unit (EPU) at the ISI, Delhi has\
        ...
        list:[
            {
                ...
                paragraphs:[
`The 2022 ACEGD conference website is <a href="https://www.isid.ac.in/~epu/acegd2022/">here</a>.`
                ]
            }
        ]
    }
